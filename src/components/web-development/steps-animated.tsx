...
import { Rocket, Code, Paintbrush, Timer, ShieldCheck, RulerDimensionLine } from 'lucide-react';
...
const features = [
  {
    ...
    title: 'Fast',
    content:
      'Automatically process all loading in backend at once to maximize more efficiency.',
    icon: <Timer className="text-primary h-6 w-6" />,
    image:
  ...
  },
  {
    ...
    title: 'Modern UI',
    content:
      'Our main goal is not just to create a website but a masterpiece',
  ...
  },
  {
    ...
    title: 'Secure',
    content:
      'Eliminate concerns over risks such as malware and hacking attack.',
  ...
  },
  {
    ...
    content:
      'Drive down costs, scale your business and grow your audience',
    icon: <RulerDimensionLine className="text-primary h-6 w-6" />,
    image:
      'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop',
  },
];
