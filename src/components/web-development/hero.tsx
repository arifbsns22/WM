...
const CodeDisplay = ({ isVisible }: { isVisible: boolean }) => {
  return (
    <div
      className={`relative max-w-5xl mx-auto px-4 transition-all duration-500 ease-in-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
    >
    ...
    <div className="font-sans">
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-black py-8 sm:py-12 px-4 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <div
            className={`text-center mb-8 sm:mb-12 transition-all duration-500 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mt-4 sm:mt-6 mb-4 sm:mb-6 leading-tight transition-colors duration-300">
              ...
              <span className="sm:hidden"> </span>all major development
              frameworks
            </h1>
            ...
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-6 sm:mb-8 leading-relaxed transition-colors duration-300">
              Collecting submissions with formcarry is super easy, there&apos;s
              no dependency needed by default and it works with all of the
