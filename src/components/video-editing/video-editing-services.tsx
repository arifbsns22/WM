...
const features = [
  {
    ...
    icon: Zap,
    description:
      "We meet deadlines with quick turnaround times without compromising quality.",
  },
  {
    title: "Unlimited Flexible Revision Support",
    icon: Infinity,
    description:
      "Your satisfaction comes first. We provide revisions until your video aligns with your creative vision.",
  },
  {
    title: "Optimized for Every Platform",
    icon: Smartphone,
    description:
      "Vertical, horizontal, square—we deliver your final video in the perfect format for any platform or device.",
  },
  {
    title: "Safe & Secure File Handling",
    icon: Lock,
    description:
      "Your footage and project files are handled privately and securely from upload to final delivery.",
  },
  {
    title: "Control",
    icon: Settings2,
