      ...
      <div>
        ...
        <ul className="mt-5 text-lg">
          <li className="flex items-center gap-2">
            <Check /> Experienced team with proven expertise
          </li>
          <li className="flex items-center gap-2">
            <Check /> On-time delivery with consistent quality
          </li>
          <li className="flex items-center gap-2">
            <Check /> Transparent and clear communication
          </li>
          <li className="flex items-center gap-2">
            <Check /> Client-focused, tailored solutions
          </li>
          <li className="flex items-center gap-2">
            <Check /> Reliable support you can depend on
          </li>
        </ul>
      </div>
    </div>
